...
float* makeSomeTechno() {
  ...
  for (int i = 0; i < 128; i++) {
    ...
    // Chords
    float chordPitch = bassPitch * 4.0f; // 200Hz, 2 octaves above bass
...
float* makeSomeTechno() {
  ...
  for (int i = 0; i < 128; i++) {
    ...
    chordPhase2 = phasor(chordPhase2, chordPitch * 3.0f/2.0f); // Perfect 5th
    float chord =
...
float* makeSomeTechno() {
  ...
  for (int i = 0; i < 128; i++) {
    ...
    chordPhase1 = phasor(chordPhase1, chordPitch);
    chordPhase2 = phasor(chordPhase2, chordPitch * 3.0f/2.0f); // Perfect 5th
    chordPhase3 = phasor(chordPhase3, chordPitch * 6.0f/5.0f); // Minor 3rd
    float chord =
      saw6f(chordPhase1 * TWO_PI) +
      saw6f(chordPhase2 * TWO_PI) +
...
float* makeSomeTechno() {
  ...
  for (int i = 0; i < 128; i++) {
    ...
    // Chords
    float chordPitch = bassPitch * 4.0f; // 200Hz, 2 octaves above bass
    if (bar % 4 == 2 || bar % 4 == 3) chordPitch *= 2.0f/3.0f; // Perfect 5th down
    chordPhase1 = phasor(chordPhase1, chordPitch);
    chordPhase2 = phasor(chordPhase2, chordPitch * 3.0f/2.0f); // Perfect 5th
    chordPhase3 = phasor(chordPhase3, chordPitch * 6.0f/5.0f); // Minor 3rd
    float chord =
...
float delayLine[SAMPLERATE] = {0}; // 48000 = 1 second of samples
